        ...
        <tbody>
          <c:forEach var="b" items="${buildings}">
            <tr>
              ...
              <td>${b.loaiToaNha}</td>
              <td class="text-end">
                <a class="btn btn-sm btn-outline-primary" href="${pageContext.request.contextPath}/buildings/${b.idToaNha}/edit">Sửa</a>
                <form action="${pageContext.request.contextPath}/buildings/${b.idToaNha}/delete" method="post" class="d-inline" onsubmit="return confirm('Xóa tòa nhà này?')">
